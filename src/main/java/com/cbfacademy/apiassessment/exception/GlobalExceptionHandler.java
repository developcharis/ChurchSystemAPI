...
/**
 * Global exception handler for the application, providing centralised exception handling
 ...
 * ResponseEntity object to the client, encapsulating the error in a standardised format.
 */
@ControllerAdvice
